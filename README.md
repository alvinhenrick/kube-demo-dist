## How to install Kubeflow (**Optional** if you have already done it with my [kube-demo-simple example](https://github.com/alvinhenrick/kube-demo-simple/blob/master/README.md))
